...
image: /images/featured_connect-custom-domain-github-pages.webp
featured: false
---
...
![Screenshot of a GitHub repository with a standard Jekyll folder structure]({{ site.baseurl }}/images/Choosing-and-Purchasing-Custom-Domain.webp)
...
![Diagram showing DNS configuration with A and CNAME records pointing to GitHub Pages.]({{ site.baseurl }}/images/Configuring-DNS-Records.webp)
